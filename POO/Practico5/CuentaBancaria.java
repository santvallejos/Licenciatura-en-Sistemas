/**
 * Clase que representa una cuenta bancaria con operaciones básicas de depósito
 * y extracción.
 * Cada cuenta bancaria está asociada a una persona (titular) y mantiene un
...
public class CuentaBancaria {
    ...
    /**
     * Constructor que inicializa una cuenta bancaria con número de cuenta y
     * titular.
    ...
    /**
     * Constructor que inicializa una cuenta bancaria con número de cuenta, titular
     * y saldo inicial.
     * 
     * @param p_nroCuenta Número único que identifica la cuenta bancaria
     * @param p_titular   Persona que es titular de la cuenta bancaria
     ...
     * @return El nuevo saldo después del depósito, o el saldo actual si el importe
     *         es inválido
     */
     ...
     * 
     * @param p_importe Cantidad de dinero a extraer (debe ser mayor a 0 y menor o
     *                  igual al saldo)
     * @return El nuevo saldo después de la extracción, o el saldo actual si la
    ...
    /**
     * Verifica si un importe específico puede extraerse de la cuenta y devuelve un
     * mensaje descriptivo.
     * 
     * @param p_importe El monto que se desea extraer.
     * @return Un mensaje indicando si el importe puede extraerse o la razón por la
     *         cual no se puede:
     */

    public String xqNoPuedoExtraer(double p_importe) {
        if (p_importe > this.getSaldo()) {
            return "No se puede extraer el importe: saldo insuficiente.";
        } else if (p_importe <= 0) {
            return "El importe a extraer debe ser mayor que cero.";
        } else {
            return "El importe puede extraerse.";
        }
    }

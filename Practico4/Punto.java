...
public class Punto
{
    ...
    public double distancia(Punto p_ptoDistancia)
    {
        // Como puedo sacar la raiz?
        return Math.sqrt(Math.pow((p_ptoDistancia.getX() - this.getX()), 2) + Math.pow((p_ptoDistancia.getY() - this.getY()), 2));
    }
